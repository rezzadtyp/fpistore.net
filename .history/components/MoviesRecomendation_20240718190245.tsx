...
const MoviesRecomendation = () => {
    const testimonials = [
        ...
        {
            title: "Rampage",
            image: "https://occ-0-64-58.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABaPaZbM69q62b83snmqn9csVspdRiREkxIk0ruUWzQ9J33vuv39OIhT9U1S2ECa0XdSSq0ujQyZLcgRyku6gl5m0pPvRJwUKVXW7-bf7cBy-mZ_xy83igq_q2-hBuMWr7qd8KHRCZhJYJLBi0NFQLtRZBM61bdOuwbsk.jpg?r=bdb",
            url: "https://netflix.com/watch/80216309?tctx=5%2C3%2C%2C%2C%2C%2C%2C%2C%2CVideo%3A80216309%2C",
        },
        {
            title: "Journey 2: The Mysterious Island",
            image: "https://occ-0-64-58.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABQoBdxV9mWrqilwUB_SU2mlaVdGwWuwai4vzhyWZxXqz4Kv3fMSCnWks_5iuqQIxw8xSz1bQbKj-nMqPI-tSsnJXfKKD4Lq8Q6CAOs2Oee3OXkcMog_AhMn3gT7ICQ-_Qd19mUNVFkqw39lUhxodjqy_OrsXXQzpKDQl.jpg?r=4be",
        ...
        {
            title: "Agak Laen",
            image: "https://occ-0-64-58.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABV_l5IiSurL9xQzm2Gio5MUymeL1wFpZlxRmJvg8UmDLooYcwu12T7FG-BBTfj6s50-yprs2aJKynSZZcRhG5yG5MAaqaarf3mLUpVojwt-9JV6iWVdnSQf9_7Si-sb-JFd4QLEvgDpv6xV5RCPEq1eEOWgJtYJRylnJ.jpg?r=631",
        ...
        },
        {
            ...
            image: "https://occ-0-64-58.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABdp81uGFO9_wFWmLurY5QtNMXhSe3axbvfcDocVNq9SY8AV4sJs_XA6Yo6zi8tqsepLtle-5MClimPRe_Ag1_UnwXu6qVG0pPLfpW5wZOuGQfJv-1ExUt9MNQu_8e44GNHVjO_oUNko4Xdf4sFbeISe6UKN79p5gE7Db.jpg?r=8da",
    ...
    return (
        <div className='rounded-md max-w-[400px] md:max-w-[800px] lg:max-w-7xl flex flex-col antialiased bg-light-100 dark:bg-dark-700 dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden'>
            <div className='w-full flex justify-start'>
                <span className='font-extrabold'>Top Movies Today</span>
            </div>
            <InfiniteMovingCards
                items={testimonials}
                direction='left'
