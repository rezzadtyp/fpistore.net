...
const LeftSidebar = () => {
  return (
    <section className='custom-scrollbar bg-light-200 dark:bg-dark-600 light-border sticky h-fit left-0 top-0 flex w-fit flex-col justify-between  overflow-y-auto border-r p-3 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]'>
