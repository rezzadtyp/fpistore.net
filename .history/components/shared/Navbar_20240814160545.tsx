...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='w-fit gap-10 backdrop-blur-sm dark:bg-dark-600/50 bg-gray-200/50 rounded-3xl md:rounded-2xl py-1 flex px-6 justify-between duration-1000 items-center dark:shadow-black/70'>
