...
const MoviesRecomendation = () => {
  ...
  return (
    <div className='rounded-md bgred max-w-screen md:max-w-[800px] lg:max-w-7xl flex flex-col antialiased bg-red-500 dark:bg-dark-700 dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden'>
