...
const MoviesRecomendation = () => {
  ...
  return (
    <div className='rounded-md max-w-screen md:max-w-[800px] lg:max-w-7xl flex flex-col antialiased bg-light-100 dark:bg-dark-700 dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden'>
