...
const Page = () => {
  ...
  return (
    <div className='flex'>
      <div className=' p-5 overflow-scroll max-h-[800px] gap-5'>
        <button className='dark:text-light-900 rounded-lg bg-primary/20 text-primary text-light-900 flex items-center justify-start gap-2 px-3 py-2 lg:p-4'>
