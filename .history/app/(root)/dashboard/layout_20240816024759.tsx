  ...
  return (
    <main className='relative '>
      ...
      <section className='flex min-h-screen justify-between flex-1 gap-6 px-6 pb-6 md:pt-10 lg:pt-24 max-md:pb-14 sm:px-14'>
        <section className='custom-scrollbar bg-white dark:bg-dark-500 light-border rounded-xl sticky h-fit lg:left-0 lg:top-4 flex w-fit md:flex-col justify-between overflow-y-auto p-6 shadow-black/20 shadow-xl dark:shadow-none lg:w-fit'>
