  ...
  return (
    <main className='relative '>
      ...
      <section className='flex min-h-screen flex-1 flex-col px-6 pb-6 pt-24 max-md:pb-14 sm:px-14'>
        <section className='bg-light-200 dark:bg-dark-500 light-border rounded-xl sticky h-fit flex w-fit flex-col justify-between overflow-y-auto p-4 shadow-black/20 shadow-xl dark:shadow-none lg:w-fit'>
